...
export class ApiService {
  ...
  login(nis: string, password: string): Observable<any> {
    return this.http.post(`${this.apiUrl}/login`, { nis, password }, {
  ...
  getBeranda(): Observable<any> {
    return this.http.get(`${this.apiUrl}/beranda`, this.getHeaders());
  }

  getMapelSaya(): Observable<any> {
    return this.http.get(`${this.apiUrl}/mapel-saya`, this.getHeaders());
  }

  getMapelDetail(id: number): Observable<any> {
    return this.http.get(`${this.apiUrl}/mapel/${id}`, this.getHeaders());
  }

  kumpulTugas(tugasId: number, formData: FormData): Observable<any> {
    const token = localStorage.getItem('token') || '';
    return this.http.post(`${this.apiUrl}/tugas/${tugasId}/kumpul`, formData, {
